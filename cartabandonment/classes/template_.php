...
class Template extends ObjectModel
{
        ...
        public function loadDefault()
        {
                ...
                empty($this->discount_text) ? 
                        $this->discount_text = '
                        <p>&nbsp;</p>
                        <p>We’re also giving you %VOUCHER_VALUE% off your entire order !</p>
                        <p>Just use coupon code %VOUCHER% at checkout.
                                <br />This code expires %VOUCHER_EXPIRE% days from the receipt of this mail so don’t wait too long!
                        </p>' : '';
	...
	{ 
        ...
        public function duplicate($name = NULL)
        {
                ...
                $keys = array('num_sending', 'with_cart_content', 'title_cart_content', 'discount', 'discount_text', 'main_color',
                        ...
                        'header', 'footer', 'conclusion', 'left_column', 'services', 'title', 'body');
